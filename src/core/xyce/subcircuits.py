...
class Neuron(SubCircuitFactory):
    NAME = 'neuron'
    NODES = ('n1', 'n2')
    def __init__(self, Rectifier:Union[str, SubCircuitFactory] = "BidRectifier", diodeModel:str='1N4148', A:Union[int, float]=4):
        super().__init__()
        if Rectifier == "BidRectifier":
          ...
          assert isinstance(Rectifier, SubCircuitFactory) , 'Rectifier should be SubCircuitFactory instance'
